    ...
    return StreamBuilder<List<TBPointRecord>>(
      stream: queryTBPointRecord(
        queryBuilder: (tBPointRecord) => tBPointRecord
          ...
          List<TBPointRecord> fishingParkMapTBPointRecordList = snapshot;
          if (_model.fishingParkMapPreviousSnapshot != null &&
              !const ListEquality(TBPointRecordDocumentEquality()).equals(
                  fishingParkMapTBPointRecordList,
                  _model.fishingParkMapPreviousSnapshot)) {
            () async {
          ...
          _model.fishingParkMapPreviousSnapshot = snapshot;
        }),
      builder: (context, snapshot) {
        ...
        List<TBPointRecord> fishingParkMapTBPointRecordList = snapshot.data!;
