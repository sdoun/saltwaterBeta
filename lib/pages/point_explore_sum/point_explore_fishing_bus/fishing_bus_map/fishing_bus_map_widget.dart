...
import 'fishing_bus_map_model.dart';
export 'fishing_bus_map_model.dart';

class FishingBusMapWidget extends StatefulWidget {
  const FishingBusMapWidget({super.key});

  @override
  State<FishingBusMapWidget> createState() => _FishingBusMapWidgetState();
}

class _FishingBusMapWidgetState extends State<FishingBusMapWidget> {
  late FishingBusMapModel _model;
