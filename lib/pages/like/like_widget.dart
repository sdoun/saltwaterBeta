              ...
              children: [
                ...
                StreamBuilder<List<TBPointRecord>>(
                  stream: queryTBPointRecord(
                    queryBuilder: (tBPointRecord) => tBPointRecord.where(
                      'point_liked_by',
                  ...
                  builder: (context, snapshot) {
                    ...
                    return Column(
                      ...
                      children: List.generate(columnTBPointRecordList.length,
                          (columnIndex) {
                                ...
                                children: [
                                  ...
                                  Column(
                                    ...
                                    children: [
                                      ...
                                      Text(
                                        columnTBPointRecord.pointCategories,
                                        style: FlutterFlowTheme.of(context)
                                            .bodyMedium
                                            .override(
                                              fontFamily: 'Readex Pro',
                                      ...
                                      Text(
                                        columnTBPointRecord.pointAddress
                                            .maybeHandleOverflow(
                                          maxChars: 15,
                                          replacement: '…',
                                        ),
