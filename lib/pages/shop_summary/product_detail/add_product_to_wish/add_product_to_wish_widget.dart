  ...
  Widget build(BuildContext context) {
    ...
    return StreamBuilder<TBShoppingProductRecord>(
      ...
      builder: (context, snapshot) {
        ...
        final bottomSheetEditTBShoppingProductRecord = snapshot.data!;
                                    ...
                                    updateAction: () async {
                                      FFAppState().chosenOptionList =
                                          _model.optionDropdownModels
                                              ...
                                              .cast<String>();
                                      setState(() {});
                                      FFAppState().addToChosenOptionStructList(
                                          WishProductOptionStruct(
                                        optionTitle:
                                            optionDropdownsItem.optionName,
                                        optionValue: _model.optionDropdownModels
                                            .getValueForKey(
                                          optionDropdownsIndex.toString(),
                                          (m) => m.dropDownValue,
                                        ),
                          ...
                          child: FFButtonWidget(
                            onPressed: () async {
                              if (functions.isNullInListString(
                                ...
                                await TBWishProductsRecord.collection
                                    .doc()
                                    .set({
