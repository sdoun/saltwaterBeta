            ...
            children: [
              ListView(
                ...
                children: [
                  ...
                  StreamBuilder<List<TBShoppingProductRecord>>(
                    ...
                    builder: (context, snapshot) {
                      ...
                      List<TBShoppingProductRecord>
                          containerTBShoppingProductRecordList = snapshot.data!;
                                        ...
                                        children: [
                                          ...
                                          Expanded(
                                            child: Builder(
                                              builder: (context) {
                                                final popularList =
                                                    containerTBShoppingProductRecordList
                                                        .toList();
                                      ...
                                      builder: (context) => Builder(
                                        builder: (context) {
                                          ...
                                          return MasonryGridView.builder(
                                            ...
                                            crossAxisSpacing: 10.0,
                                            mainAxisSpacing: 10.0,
                                            itemCount: productForBegin.length,
                                            itemBuilder: (context,
                                                productForBeginIndex) {
                                              final productForBeginItem =
                                                  productForBegin[
                                                      productForBeginIndex];
                                              return Padding(
                                                padding: const EdgeInsetsDirectional
                                      ...
                                      builder: (context) => Builder(
                                        builder: (context) {
                                          ...
                                          return MasonryGridView.builder(
                                            ...
                                            itemBuilder:
                                                (context, productByBrandIndex) {
                                              final productByBrandItem =
                                                  productByBrand[
                                                      productByBrandIndex];
                                              return Padding(
                                                padding: const EdgeInsetsDirectional
