...
import 'profile_image_upload_model.dart';
export 'profile_image_upload_model.dart';

class ProfileImageUploadWidget extends StatefulWidget {
  const ProfileImageUploadWidget({super.key});
...
class _ProfileImageUploadWidgetState extends State<ProfileImageUploadWidget> {
  late ProfileImageUploadModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => ProfileImageUploadModel());
